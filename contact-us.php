...
if ($result) {
    ...
    echo"<script> alert('Message bien envoyé! merci de nous avoir contacter')</script>"; 
                    ...
                    <div class="contact-form-right">
                        ...
                        <form id="contactForm" action="contact-us.php" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="subject" name="objet" placeholder="Subject" required data-error="Please enter your Subject">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <div class="submit-button text-center">
                                     <!-- <button class="btn hvr-hover" id="submit"  name="submit">Send Message</button> -->
                                        <input type="submit" value="Envoyer" id="submit" name="submit"  class="btn hvr-hover"  />
